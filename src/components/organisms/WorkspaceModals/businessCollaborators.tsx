...
import { addBusinessCollaborators } from "@/services/workspaces";
...
const BusinessCollaborators = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await addBusinessCollaborators(form);
...
export default BusinessCollaborators;
