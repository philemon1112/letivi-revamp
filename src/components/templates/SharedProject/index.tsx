"use client";
import { getSharedProjectDetails } from "@/services/workspaces";
...
import ProjectProfile from "../Workspace/Details/projectProfile";
import ProjectGallery from "../Workspace/Details/projectGallery";
...
function SharedProjectDetails({ name }: { name: string }) {
  // component logic
  ...
  const {
    ...
    queryKey: ["SharedProjectDetails", name],
    queryFn: () => {
      return getSharedProjectDetails(name);
    },
    select: (response) => {
              ...
              <div className="md:col-span-3">
                <div className="mx-auto max-w-screen-xl mt-4">
                  <div className=" px-2 md:px-4 bg-white py-4 md:py-6 rounded-xl">
                    <div className="flex justify-between items-center align-bottom">
                      ...
                      <a
                        download
                        href={`${process.env.NEXT_PUBLIC_OLD_API_BASE}/workspaces/download/project/${project?.id}`}
                      >
                ...
                <div className="mx-auto max-w-screen-xl bg-white !rounded-xl overflow-x-auto mt-5 no-scrollbar">
                  <div className=" px-2 bg-white py-4 md:py-6 rounded-xl">
                    ...
                    <ProjectGallery projectId={name} type="shared" />
                  </div>
                </div>
