...
import { getBusinessAlbums } from "@/services/workspaces";

function BusinessAlbumList({ businessId }: { businessId: string }) {
  ...
  const {
    ...
    queryKey: ["BusinessAlbumsData", { businessId }],
    queryFn: ({ pageParam = 1 }) =>
      getBusinessAlbums(businessId, {
        page: pageParam,
        limit: pageSize,
      }),
...
export default BusinessAlbumList;
